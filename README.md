...
| `priority`        | `<Priority>`                                          | **Android Optional** Priority of the notification. See [setPriority](<https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setPriority(int)>) for more info. <br /> **Values:** MIN / LOW / DEFAULT / HIGH / MAX <br/>                                                  |
| `importance`      | `<Importance>`                                        | **Android Optional** Sets the level of interruption of this notification channel. See [setImportance](<https://developer.android.com/reference/androidx/core/app/NotificationChannelCompat.Builder#setImportance(int)>) for more info. <br /> **Values:** NONE / MIN / LOW / DEFAULT / HIGH / MAX <br/> |
| `ongoing`         | `<boolean>`                                           | **Android Optional** Set whether this is an on-going notification.<br/> **Default:** `true`                                                                                                                                                                                                             |
| `autoCancel`      | `<boolean>`                                           | **Android Optional** Setting this flag will make it so the notification is automatically canceled when the user presses it in the panel.<br/> **Default:** `false`                                                                                                                                      |
| `stopOnTerminate` | `<boolean>`                                           | **Android Optional** Set whether background task should be teminated when app is killed.<br/> **Default:** `false`                                                                                                                                                                                      |
...
**Android only**
Listen for Android app terminating by swipping up or removing the app from recent task.

```js
DeviceEventEmitter.addListener('appKilled', () => {
